...
public class CadastroChamado implements Serializable{
  ...
  public void verificarAvaliacaoOO() throws AvaliacaoOONaoInformadaException{
      for(Chamado chamado:chamados){
          if (chamado.getAvaliacaoOO() == null){
              
              throw new AvaliacaoOONaoInformadaException("AvaliaçãoOO não foi informada em um dos chamados");
          }
      }
  }
}