...
import com.mycompany.projeto.pessoa.AvaliacaoOO;
...
public class Tela{
    ...
    switch(opcao){
      ...
      case 6:
        ...
        }catch(AvaliacaoOONaoInformadaException ex){
    ...
    public static void receberChamado(CadastroCliente cadastroCliente, CadastroAtendente cadastroAtendente, CadastroChamado cadastroChamado, CadastroEquipamento cadastroEquipamento){
        ...
        System.out.println("Deseja incluir uma AvaliacaoOO? 1- Sim Outra tecla - Não");
        
        String opcao_avaliacaoOO;
        String umString = "1";
        
        opcao_avaliacaoOO = scan.nextLine();
        
        AvaliacaoOO avaliacaoOO = new AvaliacaoOO();
        
        if(opcao_avaliacaoOO.equals(umString)){
        ...
        if(opcao_avaliacaoOO.equals(umString)){
            chamado = new Chamado(id, titulo, data_criacao, data_modificacao, servico, atendente, cliente, estado, criticidade, equipamentos, descricoes, avaliacaoOO);
        }else{
            chamado = new Chamado(id, titulo, data_criacao, data_modificacao, servico, atendente, cliente, estado, criticidade, equipamentos, descricoes, null);
        }
