...
public class Chamado implements Serializable{
  ...
  /*Criar chamado*/
  public Chamado(int id, String titulo, String data_criacao, List<String> data_modificacao, Servico servico, Atendente atendente, Cliente cliente, Estado estado, Criticidade criticidade, List<Equipamento> equipamentos, List<String> descricao, AvaliacaoOO avaliacaoOO){
    this.id = id;
    this.titulo = titulo;
